...
import com.vuduapps.bugtracker.domain.Ticket;
import com.vuduapps.bugtracker.repository.TicketRepository;
...
class TicketResourceIT {
    ...
    public static Ticket createEntity(EntityManager em) {
        Ticket ticket = new Ticket().ticket(DEFAULT_TICKET).description(DEFAULT_DESCRIPTION).dueDate(DEFAULT_DUE_DATE).done(DEFAULT_DONE);
        return ticket;
    }
    ...
    public static Ticket createUpdatedEntity(EntityManager em) {
        Ticket ticket = new Ticket().ticket(UPDATED_TICKET).description(UPDATED_DESCRIPTION).dueDate(UPDATED_DUE_DATE).done(UPDATED_DONE);
        return ticket;
    }
    ...
    void putNewTicket() throws Exception {
        ...
        updatedTicket.ticket(UPDATED_TICKET).description(UPDATED_DESCRIPTION).dueDate(UPDATED_DUE_DATE).done(UPDATED_DONE);
    ...
    void fullUpdateTicketWithPatch() throws Exception {
        ...
        partialUpdatedTicket.ticket(UPDATED_TICKET).description(UPDATED_DESCRIPTION).dueDate(UPDATED_DUE_DATE).done(UPDATED_DONE);
